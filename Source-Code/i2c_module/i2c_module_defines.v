`define STATE_BITS 6 //  The number of bits used to represent the current state
...
`define I2C_CMD_STATE_WAIT_NO_ACK1      4
`define I2C_CMD_STATE_PRESCALE_HI       5
`define I2C_CMD_STATE_WAIT_NO_ACK2      6
`define I2C_CMD_STATE_INIT2_BOOT_WAIT1  7
`define I2C_CMD_STATE_INIT2_BOOT_WAIT2  8
`define I2C_CMD_STATE_INIT_ENA          9
`define I2C_CMD_STATE_WAIT_NO_ACK3      10
`define I2C_CMD_STATE_WAIT              11
`define I2C_CMD_STATE_WAIT_NO_ACK4      12
`define I2C_CMD_STATE_WAIT_NOT_BUSY     13

// Write states
`define I2C_CMD_STATE_W_SET_SLAVE       14
`define I2C_CMD_STATE_W_WAIT_NO_ACK1    15
`define I2C_CMD_STATE_W_SET_WRITE       16
`define I2C_CMD_STATE_W_WAIT_NO_ACK2    17
`define I2C_CMD_STATE_W_READ_CHK_SR1    18
`define I2C_CMD_STATE_W_WAIT_NO_ACK3    19
`define I2C_CMD_STATE_W_SET_S_REG       20
`define I2C_CMD_STATE_W_WAIT_NO_ACK4    21
`define I2C_CMD_STATE_W_WRITE_REG       22
`define I2C_CMD_STATE_W_WAIT_NO_ACK5    23
`define I2C_CMD_STATE_W_READ_CHK_SR2    24
`define I2C_CMD_STATE_W_WAIT_NO_ACK6    25
`define I2C_CMD_STATE_W_SET_REG_VAL     26
`define I2C_CMD_STATE_W_WAIT_NO_ACK7    27
`define I2C_CMD_STATE_W_WRITE_REG_VAL   28
`define I2C_CMD_STATE_W_WAIT_NO_ACK8    29
`define I2C_CMD_STATE_W_READ_CHK_SR3    30

// Read states
`define I2C_CMD_STATE_R_SET_SLAVE_WRITE 31
`define I2C_CMD_STATE_R_WAIT_NO_ACK1    32
`define I2C_CMD_STATE_R_SET_WRITE1      33
`define I2C_CMD_STATE_R_WAIT_NO_ACK2    34
`define I2C_CMD_STATE_R_READ_CHK_SR1    35
`define I2C_CMD_STATE_R_WAIT_NO_ACK3    36
`define I2C_CMD_STATE_R_SET_S_REG       37
`define I2C_CMD_STATE_R_WAIT_NO_ACK4    38
`define I2C_CMD_STATE_R_WRITE_REG       39
`define I2C_CMD_STATE_R_WAIT_NO_ACK5    40
`define I2C_CMD_STATE_R_READ_CHK_SR2    41
`define I2C_CMD_STATE_R_WAIT_NO_ACK6    42
`define I2C_CMD_STATE_R_SET_SLAVE_READ  43
`define I2C_CMD_STATE_R_WAIT_NO_ACK7    44
`define I2C_CMD_STATE_R_SET_WRITE2      45
`define I2C_CMD_STATE_R_WAIT_NO_ACK8    46
`define I2C_CMD_STATE_R_WAIT_SRW        47
`define I2C_CMD_STATE_R_WAIT_NO_ACK9    48
`define I2C_CMD_STATE_R_SET_READ_STOP   49
`define I2C_CMD_STATE_R_WAIT_NO_ACK10   50
`define I2C_CMD_STATE_R_READ_CHK_SR3    51
`define I2C_CMD_STATE_R_WAIT_NO_ACK11   52
`define I2C_CMD_STATE_R_READ_DATA       53