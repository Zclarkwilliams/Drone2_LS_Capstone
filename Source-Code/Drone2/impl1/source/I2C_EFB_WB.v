...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n I2C_EFB_WB -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo3c00f -freq 38 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -i2c2 -i2c2_freq 400 -i2c2_sa 1000010 -i2c2_addr 7 -wb -dev 6900  */
/* Sun Mar 25 17:08:19 2018 */


`timescale 1 ns / 1 ps
module I2C_EFB_WB (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, i2c1_scl, i2c1_sda, 
    i2c1_irqo, i2c2_scl, i2c2_sda, i2c2_irqo)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
