...
`define BNO055_ACCEL_OFFSET_X_LSB_INDEX 0
`define BNO055_ACCEL_OFFSET_X_MSB_INDEX 1
`define BNO055_ACCEL_OFFSET_Y_LSB_INDEX 2
`define BNO055_ACCEL_OFFSET_Y_MSB_INDEX 3
`define BNO055_ACCEL_OFFSET_Z_LSB_INDEX 4
`define BNO055_ACCEL_OFFSET_Z_MSB_INDEX 5
`define BNO055_MAG_OFFSET_X_LSB_INDEX   6
`define BNO055_MAG_OFFSET_X_MSB_INDEX   7
`define BNO055_MAG_OFFSET_Y_LSB_INDEX   8
`define BNO055_MAG_OFFSET_Y_MSB_INDEX   9
`define BNO055_MAG_OFFSET_Z_LSB_INDEX   10
`define BNO055_MAG_OFFSET_Z_MSB_INDEX   11
`define BNO055_GYRO_OFFSET_X_LSB_INDEX  12
`define BNO055_GYRO_OFFSET_X_MSB_INDEX  13
`define BNO055_GYRO_OFFSET_Y_LSB_INDEX  14
`define BNO055_GYRO_OFFSET_Y_MSB_INDEX  15
`define BNO055_GYRO_OFFSET_Z_LSB_INDEX  16
`define BNO055_GYRO_OFFSET_Z_MSB_INDEX  17
`define BNO055_ACCEL_RADIUS_LSB_INDEX   18
`define BNO055_ACCEL_RADIUS_MSB_INDEX   19
`define BNO055_MAG_RADIUS_LSB_INDEX     20
`define BNO055_MAG_RADIUS_MSB_INDEX     21


`define BNO055_DATA_RX_BYTE_REG_CNT     46            //  The number of byte registers used to receive all measurement data
`define BNO055_CAL_DATA_REG_CNT         22            //  The number of byte registers used to store calibration data
