...
/* Module Version: 3.5 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n multiplier -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00f -type add -width 16 -signed -pipeline 0  */
/* Sun Apr 15 14:00:22 2018 */


`timescale 1 ns / 1 ps
module multiplier (DataA, DataB, Result)/* synthesis NGD_DRC_MASK=1 */;
    ...
    FADD2B addsub_0 (.A0(scuba_vlo), .A1(DataA[0]), .B0(scuba_vlo), .B1(DataB[0]), 
        .CI(scuba_vlo), .COUT(co0), .S0(), .S1(Result[0]));
